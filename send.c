...
int main(int argc, char *argv[])
{
    ...
    int Baud = 0x1c01;       // 波特率 0x1400-1M(75%), 0x1c00-500k(87.5%), 0x1c01-250k(87.5%), 0x1c03-125k(87.5%)
    ...
    int test_num = VCI_Transmit(DevType, DevIdx, 1, can_data, transmit_num);
